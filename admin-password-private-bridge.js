(() => {
  ...
  function ensureDialog() {
    ...
    dialog.innerHTML = `
      <form id="admin-password-private-form" method="dialog">
        ...
        <section id="admin-password-private-result" class="admin-password-result hidden" aria-live="polite">
          ...
          <p class="muted">Comunica questa password all'utente. Il server la restituisce cifrata e non viene salvata in chiaro in Firestore.</p>
        </section>
  ...
  window.HeraAdminPasswordPrivateBridge = {
    installed: true,
    version: VERSION,
    open: openDialog
  };
