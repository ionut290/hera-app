...
(function loadVerdeBologna() {
  ...
  const script = document.createElement("script");
  script.src = "./verde-bologna.js?v=20260901-verde-catasto1";
  script.async = false;
...
(function loadVerdeBolognaOperativo() {
  ...
  const script = document.createElement("script");
  script.src = "./verde-bologna-operativo.js?v=20260901-verde-catasto1";
  script.async = false;
...
(function loadVerdeBolognaParchiMobile() {
  ...
  const script = document.createElement("script");
  script.src = "./verde-bologna-parchi-mobile.js?v=20260901-verde-catasto1";
  script.async = false;
