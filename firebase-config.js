...
const HERA_FIRESTORE_OPERATION_DIAGNOSTICS_SRC = "firestore-operation-diagnostics.js?v=20260830-firestore-read-fix2";
const HERA_FIRESTORE_DIAGNOSTICS_V4_SRC = "firestore-diagnostics-dashboard-v4.js?v=20260805b";
const HERA_FIRESTORE_SAFE_OPTIMIZER_SRC = "firestore-safe-optimizer.js?v=20260824-isolation1";
...
const HERA_SHARED_STATIC_VIEWS_SRC = "shared-static-views.js?v=20260830-firestore-read-fix2";
const HERA_ACTIVE_COMMESSE_FIRST_BOOT_GUARD_SRC = "active-commesse-first-boot-guard.js?v=20260816-fast1";
const HERA_FIRESTORE_STARTUP_COST_OPTIMIZER_SRC = "firestore-startup-cost-optimizer.js?v=20260829-fast-squad-cache1";
...
const HERA_ADMIN_USER_ACCESS_SHARE_FIX_SRC = "admin-user-access-share-fix.js?v=20260829-credential-vault1";
const HERA_OCCASIONAL_WORKFLOW_V2_SRC = "lavori-occasionali-workflow-v2.js?v=20260830-firestore-read-fix2";
...
if (document.readyState === "loading") {
  ...
  document.write(`<script src="${HERA_OCCASIONAL_SQUAD_SITES_SRC}" data-occasional-squad-sites="1"><\/script>`);
} else {
  ...
  loadOnce(HERA_OCCASIONAL_SQUAD_SITES_SRC, "occasional-squad-sites", () => Boolean(window.HeraOccasionalSquadSites?.installed));
}
