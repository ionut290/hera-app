(() => {
  ...
  function installStyle() {
    ...
    style.textContent = `
      ...
      .rubrica-head{position:sticky;top:0;z-index:2;background:#eef4f2;padding:8px 0 12px;display:flex;align-items:center;gap:10px}
      .rubrica-head h2{margin:0;flex:1;color:#12352f}.rubrica-back,.rubrica-add{min-height:44px;border:1px solid #bfd0cb;border-radius:12px;background:#fff;padding:8px 12px;font-weight:800}
