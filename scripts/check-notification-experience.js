...
assert.doesNotMatch(html, /id="user-alert-modal"/);
assert.doesNotMatch(css, /\.user-alert-content/);
assert.doesNotMatch(app, /maybeShowUserAlert|acknowledgeActiveUserAlert|postponeActiveUserAlert/);
