...
// Verifica che il service worker usi la cache versionata attuale senza bloccare gli aggiornamenti futuri.
assert.match(serviceWorker, /const CACHE_NAME = "varga-cantieri-shell-v\d+";/);
