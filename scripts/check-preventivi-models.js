...
const loader = fs.readFileSync(path.join(root, 'preventivi-lazy-loader.js'), 'utf8');
...
assert(html.includes('preventivi-lazy-loader.js?v=20260801a'), 'Avviatore Preventivi non caricato dalla pagina.');
...
names.forEach(name => assert(loader.includes(name), `File non incluso nel caricamento su richiesta: ${name}`));
assert(loader.includes('preventivi-models.css?v=20260801a'), 'CSS non incluso nel caricamento su richiesta.');
