...
['preventivi-matrix-form-profile.js','preventivi-matrix-xlsx-fields.js','preventivi-registry-model-followup.js','preventivi-exact-xlsx.js'].forEach(file=>cp.execFileSync(process.execPath,['--check',path.join(root,file)],{stdio:'pipe'}));
...
assert(sw.includes('varga-cantieri-shell-v77'),'Cache PWA form matrice non aggiornata.');
