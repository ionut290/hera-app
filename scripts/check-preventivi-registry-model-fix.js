...
assert(sw.includes('varga-cantieri-shell-v114'),'Cache PWA form dinamico non aggiornata.');
assert(follow.includes('preventivi-exact-xlsx.js?v=20260801b'),'Compilatore XLSX non presente nel caricamento su richiesta.');
assert(follow.includes('preventivi-matrix-form-profile.js?v=20260801a'),'Profilo matrice non presente nel caricamento su richiesta.');
assert(follow.includes('preventivi-matrix-xlsx-fields.js?v=20260801a'),'Campi matrice non presenti nel caricamento su richiesta.');
assert(follow.includes('preventivi-model-driven-form.js?v=20260801b'),'Form dinamico non presente nel caricamento su richiesta.');
