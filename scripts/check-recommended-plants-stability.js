...
const checks = [
  ...
  [sw.includes('varga-cantieri-shell-v137'), 'il service worker deve usare una cache nuova'],
  [sw.includes('20260823-recommended-unfreeze1'), 'il service worker deve annunciare la versione corretta'],
