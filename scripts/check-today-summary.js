...
assert.match(index, /today-summary-interactions\.js\?v=20260728b/);
assert.match(index, /Apri la tua commessa/);
assert.match(index, /today-commesse-name/);
assert.match(index, />Inserisci ore<\/span>/);
assert.match(index, /I tuoi mezzi/);
assert.match(index, /Elenco dei mezzi/);
assert.match(index, /Visualizza i mezzi assegnati alla tua squadra/);
assert.match(index, />I tuoi avvisi<\/span>/);
assert.match(index, /squadre-restyle\.css\?v=20260728b/);
assert.match(serviceWorker, /hera-app-shell-v\d+/);
assert.match(serviceWorker, /today-summary-interactions\.js\?v=20260728b/);
assert.match(serviceWorker, /squadre-restyle\.css\?v=20260728b/);
