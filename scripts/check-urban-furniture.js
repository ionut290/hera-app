...
assert.match(source, /function renderTagDetails\(item\)/);
assert.match(source, /Tutti i dati disponibili/);
assert.match(source, /Apri la fonte originale/);
...
assert.match(css, /\.urban-furniture-detail-section/);
assert.match(sw, /urban-furniture\.js\?v=20260830-completesheet1/);
assert.match(sw, /urban-furniture\.css\?v=20260830-completesheet1/);
