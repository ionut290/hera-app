...
assert.match(loader, /verde-bologna\.js\?v=20260901-verde-routing1/);
assert.match(loader, /verde-bologna-operativo\.js\?v=20260901-verde-routing1/);
assert.match(loader, /verde-bologna-parchi-mobile\.js\?v=20260901-verde-routing1/);
assert.match(html, /app-pure-utils\.js\?v=20260901-verde-routing1/);
assert.match(html, /serviceWorker\.register\("\.\/sw\.js\?v=20260901-verde-routing1"/);
assert.match(sw, /const CACHE_NAME = "varga-cantieri-shell-v209";/);
assert.match(sw, /app-pure-utils\.js\?v=20260901-verde-routing1/);
