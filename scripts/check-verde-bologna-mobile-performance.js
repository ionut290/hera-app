...
assert.match(html, /PWA_EMERGENCY_CACHE_RESET_VERSION = "20260901-verde-totalfix1"/);
assert.match(html, /serviceWorker\.register\("\.\/sw\.js\?v=20260901-verde-totalfix1"/);
assert.match(sw, /const CACHE_NAME = "varga-cantieri-shell-v210";/);
