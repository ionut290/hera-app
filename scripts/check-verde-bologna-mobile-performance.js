...
assert.match(operationalSource, /\.verde-bologna-map\{width:100%!important;height:calc\(100dvh - 126px\)!important;min-height:420px!important;border-radius:0!important/);
...
assert.match(baseSource, /oldMap\?\.off\?\.\(\); oldMap\?\.remove\?\.\(\)/);
...
assert.match(loader, /verde-bologna\.js\?v=20260901-verde-hub1/);
assert.match(loader, /verde-bologna-operativo\.js\?v=20260901-verde-hub1/);
assert.match(loader, /verde-bologna-parchi-mobile\.js\?v=20260901-verde-hub1/);
assert.match(html, /app-pure-utils\.js\?v=20260901-verde-hub1/);
assert.match(html, /serviceWorker\.register\("\.\/sw\.js\?v=20260901-verde-hub1"/);
assert.match(sw, /const CACHE_NAME = "varga-cantieri-shell-v207";/);
assert.match(sw, /app-pure-utils\.js\?v=20260901-verde-hub1/);
