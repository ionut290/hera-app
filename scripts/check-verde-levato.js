...
assert.match(loader, /verde-levato\.js\?v=20260902-verde-levato1/);
assert.match(html, /app-pure-utils\.js\?v=20260902-verde-levato1/);
assert.match(sw, /verde-levato\.js\?v=20260902-verde-levato1/);
assert.match(sw, /"\/verde-levato\.js"/);

console.log("✅ Verde Levato: inserimento manuale, amministratore dedicato, GPS e sicurezza verificati.");
