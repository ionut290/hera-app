...
const infrastructureCss = fs.readFileSync("wastewater-infrastructure.css", "utf8");
const liftFunction = fs.readFileSync("netlify/functions/wastewater-lift-stations.js", "utf8");
...
assert.match(html, /id="wastewater-plants-kind"/);
assert.match(html, /Sollevamenti \/ stazioni di pompaggio OSM/);
...
assert.match(source, /wastewater-lift-stations/);
assert.match(source, /creative-syrniki-dddbae\.netlify\.app\/api\/wastewater-lift-stations/);
assert.match(source, /kind: "sollevamento"/);
assert.match(source, /dato collaborativo/);
...
assert.match(infrastructureCss, /\.lift-station/);
assert.match(liftFunction, /man_made/);
assert.match(liftFunction, /pumping_station/);
assert.match(liftFunction, /substance/);
assert.match(netlifyConfig, /\/api\/wastewater-lift-stations/);
assert.match(sw, /wastewater-plants\.js\?v=20260830b/);
assert.match(sw, /wastewater-plants\.css\?v=20260830a/);
assert.match(sw, /wastewater-infrastructure\.css\?v=20260830a/);
