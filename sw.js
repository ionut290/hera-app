const CACHE_NAME = "varga-cantieri-shell-v180";
const CACHE_RESET_VERSION = "20260829-tree-location1";
const APP_SHELL = [
  "./",
  "./index.html",
  ...
  "./tree-search.css?v=20260829-location1",
  "./tree-search.js?v=20260829-location1",
