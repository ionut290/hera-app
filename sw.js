const CACHE_NAME = "varga-cantieri-shell-v154";
const CACHE_RESET_VERSION = "20260826-login-stability1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260826-commessa-mobile1",
  ...
  "./accounting-v2.js?v=20260826-commessa-mobile1",
  "./commessa-impianti-menu.js?v=20260826b",
