...
const CACHE_RESET_VERSION = "20260826-administrative-calendar1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=20260826-commessa-mobile2",
  ...
  "./administrative-calendar.js?v=20260826-admin1",
  ...
  "./accounting-v2.js?v=20260826-address-autofill1",
